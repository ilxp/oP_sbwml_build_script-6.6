...
### 必要的 Patches ###
# TCP optimizations
cp -rf ./diydata/PATCH-yaof/kernel/6.7_Boost_For_Single_TCP_Flow/* ./target/linux/generic/backport-6.6/
cp -rf ./diydata/PATCH-yaof/kernel/6.8_Boost_TCP_Performance_For_Many_Concurrent_Connections-bp_but_put_in_hack/* ./target/linux/generic/hack-6.6/
cp -rf ./diydata/PATCH-yaof/kernel/6.8_Better_data_locality_in_networking_fast_paths-bp_but_put_in_hack/* ./target/linux/generic/hack-6.6/
# UDP optimizations
cp -rf ./diydata/PATCH-yaof/kernel/6.7_FQ_packet_scheduling/* ./target/linux/generic/backport-6.6/
# Patch arm64 型号名称
cp -rf ./diydata/PATCH-yaof/kernel/arm/* ./target/linux/generic/hack-6.6/
# BBRv3
cp -rf ./diydata/PATCH-yaof/kernel/bbr3/* ./target/linux/generic/backport-6.6/
# LRNG
cp -rf ./diydata/PATCH-yaof/kernel/lrng/* ./target/linux/generic/hack-6.6/
echo '
...
# wg
cp -rf ./diydata/PATCH-yaof/kernel/wg/* ./target/linux/generic/hack-6.6/
...
# OTHERS
cp -rf ./diydata/PATCH-yaof/kernel/others/* ./target/linux/generic/pending-6.6/

### Fullcone-NAT 部分 ###
# bcmfullcone
cp -rf ./diydata/PATCH-yaof/kernel/bcmfullcone/* ./target/linux/generic/hack-6.6/
# set nf_conntrack_expect_max for fullcone
wget -qO - https://github.com/openwrt/openwrt/commit/bbf39d07.patch | patch -p1
echo "net.netfilter.nf_conntrack_helper = 1" >>./package/kernel/linux/files/sysctl-nf-conntrack.conf
# FW4
mkdir -p package/network/config/firewall4/patches
cp -f ./diydata/PATCH-yaof/pkgs/firewall/firewall4_patches/*.patch ./package/network/config/firewall4/patches/
mkdir -p package/libs/libnftnl/patches
cp -f ./diydata/PATCH-yaof/pkgs/firewall/libnftnl/*.patch ./package/libs/libnftnl/patches/
sed -i '/PKG_INSTALL:=/iPKG_FIXUP:=autoreconf' package/libs/libnftnl/Makefile
mkdir -p package/network/utils/nftables/patches
cp -f ./diydata/PATCH-yaof/pkgs/firewall/nftables/*.patch ./package/network/utils/nftables/patches/
# Patch LuCI 以增添 FullCone 开关
pushd feeds/luci
patch -p1 <../.././diydata/PATCH-yaof/pkgs/firewall/luci/0001-luci-app-firewall-add-nft-fullcone-and-bcm-fullcone-.patch
popd

### Shortcut-FE 部分 ###
# Patch Kernel 以支持 Shortcut-FE
cp -rf ./diydata/PATCH-yaof/kernel/sfe/* ./target/linux/generic/hack-6.6/
...
pushd feeds/luci
patch -p1 <../.././diydata/PATCH-yaof/pkgs/firewall/luci/0002-luci-app-firewall-add-shortcut-fe-option.patch
popd

### NAT6 部分 ###
# custom nft command
patch -p1 < ./diydata/PATCH-yaof/pkgs/firewall/100-openwrt-firewall4-add-custom-nft-command-support.patch
# Patch LuCI 以增添 NAT6 开关
pushd feeds/luci
patch -p1 <../.././diydata/PATCH-yaof/pkgs/firewall/luci/0003-luci-app-firewall-add-ipv6-nat-option.patch
popd
# Patch LuCI 以支持自定义 nft 规则
pushd feeds/luci
patch -p1 <../.././diydata/PATCH-yaof/pkgs/firewall/luci/0004-luci-add-firewall-add-custom-nft-rule-support.patch
popd

### natflow 部分 ###
pushd feeds/luci
patch -p1 <../.././diydata/PATCH-yaof/pkgs/firewall/luci/0005-luci-app-firewall-add-natflow-offload-support.patch
popd

### fullcone6 ###
pushd feeds/luci
patch -p1 <../.././diydata//PATCH-yaof/pkgs/firewall/luci/0007-luci-app-firewall-add-fullcone6-option-for-nftables-.patch
popd
...
# btf
cp -rf ./diydata/PATCH-yaof/kernel/btf/* ./target/linux/generic/hack-6.6/
...
cp -rf ./diydata/PATCH-yaof/kernel/rockchip/* ./target/linux/rockchip/patches-6.6/
...
merge_package master https://github.com/openwrt/packages.git package/new lang/golang
# mount cgroupv2
pushd feeds/packages
patch -p1 <../.././diydata/PATCH-yaof/pkgs/cgroupfs-mount/0001-fix-cgroupfs-mount.patch
popd
mkdir -p feeds/packages/utils/cgroupfs-mount/patches
cp -rf ./diydata/PATCH-yaof/pkgs/cgroupfs-mount/900-mount-cgroup-v2-hierarchy-to-sys-fs-cgroup-cgroup2.patch ./feeds/packages/utils/cgroupfs-mount/patches/
cp -rf ./diydata/PATCH-yaof/pkgs/cgroupfs-mount/901-fix-cgroupfs-umount.patch ./feeds/packages/utils/cgroupfs-mount/patches/
cp -rf ./diydata/PATCH-yaof/pkgs/cgroupfs-mount/902-mount-sys-fs-cgroup-systemd-for-docker-systemd-suppo.patch ./feeds/packages/utils/cgroupfs-mount/patches/
# fstool
...
cp -rf ./diydata/PATCH-yaof/pkgs/miniupnpd/301-options-force_forwarding-support.patch ./feeds/packages/net/miniupnpd/patches/
pushd feeds/packages
patch -p1 <../.././diydata/PATCH-yaof/pkgs/miniupnpd/01-set-presentation_url.patch
patch -p1 <../.././diydata/PATCH-yaof/pkgs/miniupnpd/02-force_forwarding.patch
popd
pushd feeds/luci
patch -p1 <../.././diydata/PATCH-yaof/pkgs/miniupnpd/luci-upnp-support-force_forwarding-flag.patch
popd
# 动态DNS
...
# IPv6 兼容助手
patch -p1 <./diydata/PATCH-yaof/pkgs/odhcp6c/1002-odhcp6c-support-dhcpv6-hotplug.patch
# ODHCPD
mkdir -p package/network/services/odhcpd/patches
cp -f ./diydata/PATCH-yaof/pkgs/odhcpd/0001-odhcpd-improve-RFC-9096-compliance.patch ./package/network/services/odhcpd/patches/0001-odhcpd-improve-RFC-9096-compliance.patch
