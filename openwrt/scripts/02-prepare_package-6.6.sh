...
# wwan
#git clone https://github.com/sbwml/wwan-packages package/new/wwan  #编译失败
...
#curl -s $mirror/openwrt/patch/luci/applications/luci-app-frpc/001-luci-app-frpc-hide-token.patch | patch -p1   #打不上
